        ...
        <div className="flex justify-between items-center px-10 w-full max-w-[1280px] mx-auto h-20">
          <div className="flex items-center gap-8">
            ...
            <nav className="hidden md:flex gap-6 items-center h-full">
              ...
              <Link className="font-headline-md text-headline-md uppercase tracking-wider text-primary border-b-2 border-primary pb-1" href="/cms/certification">Certified</Link>
            </nav>
          </div>
          <div className="flex items-center gap-4">
            <Link href="/" className="bg-primary text-white px-6 py-2 rounded-[6px] font-headline-md text-[16px] uppercase hover:opacity-90 transition-opacity">
              Enquire
            </Link>
          </div>
        </div>
