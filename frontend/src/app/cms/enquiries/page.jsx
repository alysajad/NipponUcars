        ...
        <div className="flex justify-between items-center px-10 w-full max-w-[1280px] mx-auto h-20">
          <div className="flex items-center gap-8">
            ...
            <nav className="hidden md:flex gap-6 items-center h-full">
              ...
              <Link className="font-headline-md text-headline-md uppercase tracking-wider text-primary border-b-2 border-primary pb-1" href="/cms/enquiries">Enquiries</Link>
