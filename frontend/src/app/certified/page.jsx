            ...
            <div className="max-w-container-max mx-auto px-margin-desktop">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="bg-white p-12 rounded-2xl shadow-lg border-t-4 border-primary group hover:-translate-y-2 transition-all duration-300">
                        ...
                        <p className="text-secondary font-body-md text-body-md leading-relaxed">A Nippon U-CARS certificate is a transferable asset that significantly increases the market value of your vehicle.</p>
                    </div>
                </div>
            </div>
        </section>
